...
public class NorGate implements IComponent {
    ...
    private Tristate nor(Tristate a, Tristate b) {
        if (a == Tristate.TRUE || b == Tristate.TRUE) return Tristate.FALSE;
